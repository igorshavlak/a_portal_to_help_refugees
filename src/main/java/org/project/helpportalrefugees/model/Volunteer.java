...
public class Volunteer extends User{
    ...
    public Volunteer(String id, String name, String surname, LocalDate dateOfBirth, String phone, String city, String country, String skillsOrExperience,byte[]image) {
    ...
    public Volunteer(String name, String surname, LocalDate dateOfBirth, String phone, String city, String country, String skillsOrExperience, byte[] image) {
